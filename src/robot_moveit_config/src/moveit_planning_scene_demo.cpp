...
//   arm.move();
  ...
  box_primitive.dimensions[0] = 0.288;
  ...
  q1.setRPY(0, -M_PI/2, 0);  // Roll=0, Pitch=-90°, Yaw=0
  ...
  q2.setRPY(0, M_PI/2, 0);  // Roll=0, Pitch=90°, Yaw=0
  ...
  target_pose.pose.orientation.y = q2.y();
  target_pose.pose.orientation.z = q2.z();
  target_pose.pose.orientation.w = q2.w();
